...
CHECKLIST_LEGALE = [
    ...
    ("Finalités du traitement (RGPD art. 13-1-c)", r"finalit"),
    ...
    ("Droit d'accès (RGPD art. 15)", r"accès"),
    ("Droit de rectification (RGPD art. 16)", r"rectification"),
    ("Droit à l'effacement (RGPD art. 17)", r"effacement|suppression"),
    ("Droit à la limitation (RGPD art. 18)", r"limitation"),
    ("Droit à la portabilité (RGPD art. 20)", r"portabilit"),
    ("Droit d'opposition (RGPD art. 21)", r"opposition"),
